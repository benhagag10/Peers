              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="px-3 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white/70">
                  ...
                  {/* Description */}
                  <div>
                    <label htmlFor="link-description" className="block text-sm font-medium text-white/70 mb-1.5">
                  ...
                  {/* URL (optional) */}
                  <div>
                    <label htmlFor="link-url" className="block text-sm font-medium text-white/70 mb-1.5">
                      URL (optional)
                    </label>
                    <input
                      id="link-url"
